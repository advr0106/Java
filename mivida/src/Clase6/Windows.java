...
public class Windows implements SistemaOperativo{
    ...
    public void instalar() {
        System.out.println("Instala los programas necesarios del sistema");
    }
    ...
    public void ejecutar() {
        instalar();
        System.out.println("Ejecuta las aplicaciones instaladas del sistema");
    }
    ...
    public void almacenar() {
        instalar();
        System.out.println("Almacena la informacion instalada en el sistema que sea necesaria");
    }
